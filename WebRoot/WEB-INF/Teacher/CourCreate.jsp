    ...
    <a href="#" class="visible-phone"><i class="icon icon-th-list"></i> Common Elements</a>
        ...
        <li class="active submenu open">
            ...
            <ul>
                ...
                <li class="active"><a href="${ctx}/CourCreate1.action">新建课程</a></li>
            </ul>
        </li>
            ...
            <div class="span8" style="text-align:center;">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form action="${ctx}/courCreate.action" method="post" class="form-horizontal" >
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input name="cstart" type="text" data-date="2012-02-12" data-date-format="yyyy-mm-dd" value="2012-02-12" class="datepicker" />
                            </div>
                        </div>
