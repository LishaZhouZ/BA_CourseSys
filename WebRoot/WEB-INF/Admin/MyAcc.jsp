            ...
            <div class="span8" style="text-align:center;">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
	                   ...
	                   <form class="form-horizontal" method="post" action="ChangePass.action" name="password_validate" id="password_validate" novalidate="novalidate">
