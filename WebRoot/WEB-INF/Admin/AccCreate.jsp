...
<div id="user-nav" class="navbar navbar-inverse">
    <ul class="nav btn-group">
        <li class="btn btn-inverse"><a title="" href="index"><i class="icon icon-share-alt"></i> <span class="text">登出</span></a></li>
    </ul>
</div>
...
<div id="sidebar">
   ...
   <ul>
        <li class="active submenu open">
            ...
            <ul>
                <li><a href="${ctx}/Alogin.action">账户一览</a></li>
                <li class="active"><a href="${ctx}/AccCreate.action">创建账户</a></li>
            </ul>
        </li>
...
<div id="content">
    ...
    <div id="breadcrumb">
    <a href="#" class="tip-bottom"><i class="icon-home"></i>主页</a>
    <a href="#" class="current">创建账户</a>
    </div>
            ...
            <div class="span8" style="text-align:center;">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form action="acccreate.action" method="post" class="form-horizontal" >
